...
param seeder_containerimage string

param seeder_containerport string

param sql_outputs_sqlserverfqdn string

param seeder_identity_outputs_id string

param seeder_identity_outputs_clientid string
...
resource mainContainer 'Microsoft.Web/sites/sitecontainers@2025-03-01' = {
  ...
  properties: {
    ...
    image: seeder_containerimage
    isMain: true
    targetPort: seeder_containerport
...
resource webapp 'Microsoft.Web/sites@2025-03-01' = {
  name: take('${toLower('seeder')}-${uniqueString(resourceGroup().id)}', 60)
  location: location
  properties: {
    serverFarmId: app_service_env_outputs_planid
    keyVaultReferenceIdentity: seeder_identity_outputs_id
    siteConfig: {
      numberOfWorkers: 30
      ...
      appSettings: [
        ...
        }
        {
          ...
          value: seeder_identity_outputs_clientid
        }
        {
  ...
  identity: {
    ...
    userAssignedIdentities: {
      ...
      '${seeder_identity_outputs_id}': { }
    }
  }
}

resource seeder_website_ra 'Microsoft.Authorization/roleAssignments@2022-04-01' = {

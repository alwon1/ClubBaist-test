...
resource script_sql_clubbaist 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sql', principalName, 'clubbaist', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
